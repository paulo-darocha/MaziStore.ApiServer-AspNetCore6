...
namespace MaziStore.Module.Orders.Areas.Orders.ViewModels
{
   public class OrderDetailVm
   {
      ...
      {
         get { return _currencyService.FormatCurrency(DiscountAmount); }
      }

      public string SubtotalWithDiscountString
      {
         get { return _currencyService.FormatCurrency(SubTotalWithDiscount); }
      }

      public string TaxAmountString
      {
         get { return _currencyService.FormatCurrency(TaxAmount); }
      }

      public string ShippingAmountString
      {
         get { return _currencyService.FormatCurrency(ShippingAmount); }
      }

      public string PaymentFeeAmountString
      {
         get { return _currencyService.FormatCurrency(PaymentFeeAmount); }
      }

      public string OrderTotalString
      {
         get { return _currencyService.FormatCurrency(OrderTotal); }
      }
