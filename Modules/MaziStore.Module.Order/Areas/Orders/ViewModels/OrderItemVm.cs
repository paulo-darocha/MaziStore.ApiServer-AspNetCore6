...
namespace MaziStore.Module.Orders.Areas.Orders.ViewModels
{
   public class OrderItemVm
   {
      ...
      public string ProductPriceString =>
         _currencyService.FormatCurrency(ProductPrice);

      public string DiscountAmountString =>
         _currencyService.FormatCurrency(DiscountAmount);

      public string TotalString => _currencyService.FormatCurrency(Total);

      public string TaxIncludedAmountString =>
         _currencyService.FormatCurrency(TaxIncludedAmount);
      ...
      public static IEnumerable<ProductVariationOptionVm> GetVariationOption(
         Product variation
      )
      {
         if (variation == null)
         ...
         return variation.OptionCombinations.Select(
            x =>
               new ProductVariationOptionVm
               {
