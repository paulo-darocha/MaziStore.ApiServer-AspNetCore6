      ...
      public static void SeedData(ModelBuilder builder)
      {
         builder
            ...
            .HasData(
               ...
               new AppSetting("Global.AssetBundling")
               {
                  Module = "Core",
                  IsVisibleInCommonSettingPage = true,
                  Value = "false"
               },
               new AppSetting("Theme")
               {
                  Module = "Core",
                  IsVisibleInCommonSettingPage = false,
                  Value = "Generic"
               },
               new AppSetting("Global.DefaultCultureUI")
               {
                  Module = "Core",
                  IsVisibleInCommonSettingPage = true,
                  Value = "en-US"
               },
               new AppSetting("Global.DefaultCultureAdminUI")
               {
                  Module = "Core",
                  IsVisibleInCommonSettingPage = true,
                  Value = "en-US"
               },
               new AppSetting("Global.CurrencyCulture")
               {
                  Module = "Core",
                  IsVisibleInCommonSettingPage = true,
                  Value = "en-US"
               },
               new AppSetting("Global.CurrencyDecimalPlace")
               {
                  Module = "Core",
                  IsVisibleInCommonSettingPage = true,
                  Value = "2"
         ...
         builder
            ...
            .HasData(
               new User
               {
                  ...
                  LatestUpdatedOn = new DateTimeOffset(
                     new DateTime(
                        2018,
                        5,
                        29,
         ...
         builder
            .Entity<UserRole>()
            .HasData(new UserRole { UserId = 10, RoleId = 1 });
         ...
         builder
            .Entity<StateOrProvince>()
            .HasData(
               new StateOrProvince(1)
               {
                  CountryId = "PT",
                  Name = "Porto",
                  Type = "State"
               },
               new StateOrProvince(2)
               {
                  CountryId = "US",
                  Name = "Washington",
                  Code = "WA"
               },
               new StateOrProvince(3)
               {
                  CountryId = "BR",
                  Name = "São Paulo",
                  Code = "SP",
