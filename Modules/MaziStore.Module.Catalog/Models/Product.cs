...
namespace MaziStore.Module.Catalog.Models
{
   public class Product : Content
   {
      ...
      public IList<ProductMedia> Medias { get; protected set; } =
         new List<ProductMedia>();

      public IList<ProductLink> ProductLinks { get; protected set; } =
         new List<ProductLink>();

      public IList<ProductLink> LinkedProductLinks { get; protected set; } =
         new List<ProductLink>();

      public IList<ProductAttributeValue> AttributeValues { get; protected set; } =
         new List<ProductAttributeValue>();

      public IList<ProductOptionValue> OptionValues { get; protected set; } =
         new List<ProductOptionValue>();

      public IList<ProductCategory> Categories { get; protected set; } =
         new List<ProductCategory>();

      public IList<ProductPriceHistory> PriceHistories { get; protected set; } =
      ...
      public IList<ProductOptionCombination> OptionCombinations
      {
         get;
         protected set;
      ...
      public Product Clone()
      {
         ...
         {
            product.AddCategory(
               new ProductCategory { CategoryId = category.CategoryId }
            );
         }
