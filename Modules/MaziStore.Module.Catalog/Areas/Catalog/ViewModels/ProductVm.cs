...
namespace MaziStore.Module.Catalog.Areas.Catalog.ViewModels
{
   public class ProductVm
   {
      ...
      public IList<ProductMediaVm> ProductImages { get; set; } =
      ...
      public List<ProductLinkVm> RelatedProducts { get; set; } =
         new List<ProductLinkVm>();

      public List<ProductLinkVm> CrossSellProducts { get; set; } =
         new List<ProductLinkVm>();
   }
}
