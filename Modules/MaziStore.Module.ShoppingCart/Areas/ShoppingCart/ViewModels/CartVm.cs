...
namespace MaziStore.Module.ShoppingCart.Areas.ShoppingCart.ViewModels
{
   public class CartVm
   {
      ...
      {
         get { return _currencyService.FormatCurrency(Discount); }
      }
      ...
      public string TaxAmountString
      {
         get
         {
            return TaxAmount.HasValue
               ? _currencyService.FormatCurrency(TaxAmount.Value)
               : "-";
         }
      }
      ...
      public string ShippingAmountString
      {
         get
         {
            return ShippingAmount.HasValue
               ? _currencyService.FormatCurrency(ShippingAmount.Value)
               : "-";
         }
      }
